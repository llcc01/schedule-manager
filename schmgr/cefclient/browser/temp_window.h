...
#include "schmgr/cefclient/browser/client_types.h"

#if defined(OS_WIN)
#include "schmgr/cefclient/browser/temp_window_win.h"
#elif defined(OS_LINUX)
#include "schmgr/cefclient/browser/temp_window_x11.h"
#elif defined(OS_MAC)
#include "schmgr/cefclient/browser/temp_window_mac.h"
#endif
