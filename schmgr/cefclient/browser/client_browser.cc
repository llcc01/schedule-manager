...
#include "schmgr/cefclient/browser/client_browser.h"
...
class ClientBrowserDelegate : public ClientAppBrowser::Delegate {
 public:
  ...
  void OnBeforeCommandLineProcessing(
    ...
    command_line->AppendSwitchWithValue("lang", "zh");
    command_line->AppendSwitchWithValue("user-data-dir", core::GetExePath() + "\\user_data");
  }
