...
// #include "schmgr/cefclient/browser/binding_test.h"
#include "schmgr/cefclient/browser/client_handler.h"
// #include "schmgr/cefclient/browser/dialog_test.h"
#include "schmgr/cefclient/browser/main_context.h"
// #include "schmgr/cefclient/browser/media_router_test.h"
// #include "schmgr/cefclient/browser/preferences_test.h"
#include "schmgr/cefclient/browser/resource.h"
// #include "schmgr/cefclient/browser/response_filter_test.h"
#include "schmgr/cefclient/browser/root_window_manager.h"
// #include "schmgr/cefclient/browser/scheme_test.h"
// #include "schmgr/cefclient/browser/server_test.h"
// #include "schmgr/cefclient/browser/urlrequest_test.h"
// #include "schmgr/cefclient/browser/window_test.h"

#include "schmgr/shared/browser/resource_util.h"
...
namespace client
{
  namespace test_runner
  {
    ...
    namespace
    {
      ...
      const char kTestOrigin[] = "http://ceftest/";
      ...
      void RunRequestTest(CefRefPtr<CefBrowser> browser)
      {
        ...
        if (browser->GetMainFrame()->GetURL().ToString().find("http://ceftest/") != 0)
        {
          // The LoadRequest method will fail with "bad IPC message" reason
          // INVALID_INITIATOR_ORIGIN (213) unless you first navigate to the
          // request origin using some other mechanism (LoadURL, link click, etc).
          Alert(browser,
                "Please first navigate to a http://ceftest/ URL. "
                "For example, first load Tests > Other Tests.");
          return;
        }

        // Set the request URL
        request->SetURL("http://ceftest/request");
      ...
      {
        browser->GetMainFrame()->LoadURL("http://ceftest/other_tests");
      }
      ...
      public:
        ...
        bool OnRequest(scoped_refptr<CefResourceManager::Request> request) override
        {
          ...
          {
            // Not handled by this provider.
            return core::back::ResourceHandler(request);
...
// Add provider for bundled resource files.
    ...
    void ConsoleLog(CefRefPtr<CefBrowser> browser, const std::string &message)
    {
      if (browser->GetHost()->GetExtension())
      {
        // Alerts originating from extension hosts should instead be displayed in
      ...
      // Execute a JavaScript alert().
      CefRefPtr<CefFrame> frame = browser->GetMainFrame();
      frame->ExecuteJavaScript("console.log('" + msg + "');", frame->GetURL(), 0);
    }
